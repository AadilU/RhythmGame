...
public class MainMenuNotLaggyVersionButHasNoAudio extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MainMenuNotLaggyVersionButHasNoAudio frame = new MainMenuNotLaggyVersionButHasNoAudio();
	...
	public MainMenuNotLaggyVersionButHasNoAudio() {
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {	
				MouseStatusNotLaggyVersionButHasNoAudio.action(player, 1); 	//stops main menu music, plays click sound, opens song selection ui
