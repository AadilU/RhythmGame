...
import control.MouseStatusNotLaggyVersionButHasNoAudio;
...
public class SongSelectUIDynNotLaggyVersionButHasNoAudio extends JFrame{
	/**
	 * 
	 */
	...
	public SongSelectUIDynNotLaggyVersionButHasNoAudio(int skin) {
		int i = skin;
		//creating frame
		...
		btnSkin1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MouseStatusNotLaggyVersionButHasNoAudio.action(player, 1);
				dispose();
			}
		});
		...
		btnSkin2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MouseStatusNotLaggyVersionButHasNoAudio.action(player, 2);
				dispose();
			}
		});
		...
		btnSkin3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MouseStatusNotLaggyVersionButHasNoAudio.action(player, 3);
				dispose();
			}
		});
		...
		btnSong1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				MouseStatusNotLaggyVersionButHasNoAudio.action(player, 0); //check MouseStatus class in control package for comments of this method
			}
		});
		MouseStatusNotLaggyVersionButHasNoAudio.state(panel, menuBg, lblSongName, btnSong1, 1, player, i); //check MouseStatus class in control package for comments of this method
		...
		MouseStatusNotLaggyVersionButHasNoAudio.state(panel, menuBg, lblSongName, btnSong2, 2, player, i); //check MouseStatus class in control package for comments of this method
		...
		MouseStatusNotLaggyVersionButHasNoAudio.state(panel, menuBg, lblSongName, btnSong3, 3, player, i); //check MouseStatus class in control package for comments of this method
